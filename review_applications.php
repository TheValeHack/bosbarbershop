...
<head>
    ...
    <title>Review Applications - Bos Barbershop</title>
...
<body>
    ...
    <div class="container-acc mt-5">
        <h1>Choose Job Vacancy to review</h1>
                    ...
                    <ul class="list-unstyled">
                        <?php foreach ($results as $job): ?>
                            <li class="result mb-2 d-flex flex-column">
                                ...
                                <div class="apply-btn">
                                    <a href="review.php?id=<?php echo htmlspecialchars($job['vacancy_id']); ?>">Review</a>
                                </div>
                            </li>
                        <?php endforeach; ?>
                    </ul>
